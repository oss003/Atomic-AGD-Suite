...
; Amstrad CPC Engine v0.6 modified.
; 
; 2018-06-20 modified by Shining for PinkPills
; Changes:
;   Removed support for SFX.
;   Changed placement in RAM.
;   Inserted capability to play pt3 -ongs using user-command.
;   Caution: Loader puts a vector-table in ram, starting from 0x8003. First two bytes represent adress of song init/play routine.
;   Next bytes represent start-adress of compressed songs (6 at the moment).
;   If player-code and songs are not present, game will crash using user-command.

; Global definitions ------------------------------------------------------------

SHRAPN equ $7AB6  ;Shining 40630           ; shrapnel table, just below map.
MAP    equ $7C00  ;Shining 40960           ; properties map buffer.
MAPHI  equ $7C    ;Shining 160             ; high byte of MAP.
