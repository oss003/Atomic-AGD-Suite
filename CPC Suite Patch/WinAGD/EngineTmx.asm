...
; Set palette routine not required for Timex Sinclair.
...
w8912  ld hl,snddat        ; start of AY-3-8912 register data.
       ...
       ld b,255            ; high byte of port to write.
w8912a ld c,245            ; port 65525=select soundchip register.
       out (c),e           ; tell chip which register we're writing.
       ld a,(hl)           ; value to write.
       inc c               ; port 65526=write value to register.
